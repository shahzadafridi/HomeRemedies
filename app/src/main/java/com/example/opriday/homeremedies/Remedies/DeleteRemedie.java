...
public class DeleteRemedie extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (TextUtils.isEmpty(getName) && TextUtils.isEmpty(getType) && TextUtils.isEmpty(getDetail)){
            Toast.makeText(DeleteRemedie.this,"Enter complete detail!",Toast.LENGTH_SHORT).show();
        }else {
                ...
                public void onResponse(Call<Respond> call, Response<Respond> response) {
                    ...
                    if (res.getSuccess().contains("1")){
                        ...
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Intent intent = new Intent(DeleteRemedie.this,HomeRemedie.class);
